...
public class MISMessage extends MinaWritable {
	...
	public MISMessage(MISMessageType type, int selectedNeighborId) {
		this(type);
		this.int1 = selectedNeighborId;
	}

	public MISMessage(MISMessageType type) {
		this.type = type;
	}
	...
	public static MISMessage removeNeighborMessage(int neighborId) {
		return new MISMessage(MISMessageType.REMOVE_NEIGHBOR, neighborId);
		
	}

	public static MISMessage newNeighborSelectedAsPossibleMessage(int neighborId) {
		return new MISMessage(MISMessageType.NEIGHBOR_SELECTED_AS_POSSIBLE, neighborId);
	}

	public static MISMessage newHasANeighborInSetMessage() {
		return new MISMessage(MISMessageType.HAS_A_SELECTED_NEIGHBOR);
	}
}