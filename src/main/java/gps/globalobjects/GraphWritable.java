...
public abstract class GraphWritable extends MinaWritable {
	
	public List<NodeWritable> nodes;

	public GraphWritable() {
		nodes = new ArrayList<NodeWritable>();
	}

	public GraphWritable(List<NodeWritable> nodes) {
		this.nodes = nodes;
	}
	...
	public void read(IoBuffer ioBuffer) {
		...
		nodes = new ArrayList<NodeWritable>(numVertices);
